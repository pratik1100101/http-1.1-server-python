...
@pytest.fixture
def web_server_instance(mocker):
...
def test_request_initialization_with_all_optional_args():
...
def test_request_initialization_none():
...
#### __INIT__() TESTS. ####
# Test basic initialization with all required arguments.
def test_webserver_initialization(web_server_instance):
...
def test_webserver_init_invalid_web_root_dir_non_existent(mocker):
...
def test_webserver_init_invalid_web_root_dir_not_a_dir(mocker):
...
def test_webserver_start_and_shutdown(mocker):
...
def test_add_multiple_middleware(web_server_instance):
...
def test_parse_request_from_buffer_valid_get(web_server_instance):
    raw_request = b"GET /index.html HTTP/1.1\r\nHost: example.com\r\n\r\n"

    parsed_components, consumed_bytes = web_server_instance.parse_request_from_buffer(
        raw_request
    )
...
def test_parse_request_from_buffer_valid_post_with_body(web_server_instance):
...
def test_parse_request_from_buffer_incomplete_request(web_server_instance):
...
def test_parse_request_from_buffer_incomplete_body(web_server_instance):
    raw_request = (
...
def test_parse_request_from_buffer_query_params(web_server_instance):
...
def test_parse_request_from_buffer_invalid_format_no_method(web_server_instance):
    raw_request = (
...
def test_parse_request_from_buffer_invalid_header_format(web_server_instance):
    raw_request = (
...
def test_parse_request_from_buffer_exact_body_length(web_server_instance):
...
def test_parse_request_from_buffer_extra_data_after_body(web_server_instance):
    body = b"short_body"
    extra_data = b"GET /next HTTP/1.1\r\n\r\n"  # Another request immediately following.
    raw_request = (
...
def test_parse_request_from_buffer_multiple_headers(web_server_instance):
    raw_request = (
        b"GET /page HTTP/1.1\r\n"
        b"Host: test.com\r\n"
...
def test_parse_request_from_buffer_no_headers(web_server_instance):
...
def test_parse_request_from_buffer_http_1_0(web_server_instance):
...
def test_parse_request_from_buffer_special_chars(web_server_instance):
    ...
    assert parsed_components["params"] == {"param_with_[]": "val", "another": "1.2.3"}
    assert consumed_bytes == len(raw_request)


# Test a request with empty buffer.
def test_parse_request_from_buffer_empty_buffer(web_server_instance):
    buffer = b""
    parsed_components, consumed_bytes = web_server_instance.parse_request_from_buffer(
        buffer
    )
...
def test_parse_request_from_buffer_partial_start_line(web_server_instance):
    buffer = b"GET / "
    parsed_components, consumed_bytes = web_server_instance.parse_request_from_buffer(
        buffer
    )
...
def test_parse_request_from_buffer_no_header_crlf(web_server_instance):
...
def test_parse_url_path_and_query_basic_path(web_server_instance):
...
def test_parse_url_path_and_query_simple_query(web_server_instance):
...
def test_parse_url_path_and_query_encoded_spaces_in_path(web_server_instance):
...
def test_parse_url_path_and_query_complex_encoded_query(web_server_instance):
...
def test_parse_url_path_and_query_multiple_values_for_key(web_server_instance):
...
def test_parse_url_path_and_query_blank_values(web_server_instance):
...
def test_parse_url_path_and_query_only_path_root(web_server_instance):
    path_with_query_str = "/"
    decoded_path, query_params = web_server_instance.parse_url_path_and_query(
        path_with_query_str
    )
...
def test_parse_url_path_and_query_encoded_path_with_plus_for_space(web_server_instance):
...
def test_parse_url_path_and_query_no_path_just_query(web_server_instance):
...
def test_parse_url_path_and_query_empty_string(web_server_instance):
    path_with_query_str = ""
    decoded_path, query_params = web_server_instance.parse_url_path_and_query(
        path_with_query_str
    )
...
def test_parse_url_path_and_query_query_with_no_values(web_server_instance):
...
def test_send_response_200_ok(web_server_instance, mock_client_socket):
    status_code = 200
    ...
    assert "Connection: keep-alive\r\n" in sent_string  # 200 OK should be keep-alive
...
def test_send_response_404_not_found(web_server_instance, mock_client_socket):
    status_code = 404
...
def test_send_response_204_no_content(web_server_instance, mock_client_socket):
...
def test_send_response_different_content_type(web_server_instance, mock_client_socket):
    status_code = 200
...
def test_send_response_error_handling(web_server_instance, mock_client_socket, mocker):
    status_code = 200
    content_type = "text/plain"
